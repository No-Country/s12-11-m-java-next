            ...
            <div className='flex flex-col h-full justify-center items-center'>
                ...
                <form className='flex flex-col gap-6 mb-5 w-2/4'>
                    <div className='flex flex-col gap-2'>
                        <label>Email</label>
                        <input className='p-2 bg-[#151515] border-2 rounded-xl border-gray-700' type="text" placeholder='Email' />
                    </div>
                    <div className='flex flex-col gap-2'>
                        <label>Contraseña</label>
                        <input className='p-2 bg-[#151515] border-2 rounded-xl border-gray-700' type="password" placeholder='Contraseña' />
                    </div>
