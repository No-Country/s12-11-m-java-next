    ...
    return (
        <div className="flex items-center justify-center w-38 ">
            <label htmlFor="dropzone-file"
                ...
                rounded-full cursor-pointer bg-slate-100 dark:hover:bg-slate-100 dark:bg-slate-100 
                ...
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                    ...
                    <p className="mb-2 text-sm text-gray-500 dark:text-gray-400"><span className="font-semibold">Añadir foto</span>
                    </p>
